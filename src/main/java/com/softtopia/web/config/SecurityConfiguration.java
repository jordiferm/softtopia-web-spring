...
import com.softtopia.web.security.*;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/app/rest/technology-body/**").permitAll()
                .antMatchers("/app/rest/blogs/**").permitAll()
                .antMatchers("/app/rest/blog-body/**").permitAll()
